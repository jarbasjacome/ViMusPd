...
#ifndef _OPENALSAMPLERCORACOES_H_
#define _OPENALSAMPLERCORACOES_H_
 ...
 *
 */
class OpenALSamplerCoracoes
{
	public:

		OpenALSamplerCoracoes();
		virtual ~OpenALSamplerCoracoes();
...
#endif //_OPENALSAMPLERCORACOES_H_
