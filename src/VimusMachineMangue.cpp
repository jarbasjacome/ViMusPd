...
/**
 * VimusMachineMangue default constructor.
 */
VimusMachineMangue::VimusMachineMangue()
{
    ...
    if (DEBUG_MODE)
        cout << "\nVimusMachineMangue constructed.";
...
/**
 * Update VimusMachineMangue.
 */
void VimusMachineMangue::update()
{
    this->frame.data = (*this->ppInputData);
...
//                        cout << "\n camZ = " << camZ;
    ...
    {
        cout << "\nError at ViMusMachineMangue update.";
    }
}

/**
 * Draw VimusMachineMangue.
 */
void VimusMachineMangue::draw()
{
    glPushMatrix();
...
void VimusMachineMangue::updateState()
{
    float step;
    switch (state)
    {
 ...
 * two blobs distance.
 */
void VimusMachineMangue::treatBlobsGestures()
{
    bool blob2 = false;
...
void VimusMachineMangue::setState(int nextState)
{
    switch (state)
    {
    case STATE_USER_INPUT:
...
void VimusMachineMangue::resetPosArrays()
{
    posXorigin = 0;
    posYorigin = 0;
    posX = 0;
 ...
 */
void VimusMachineMangue::moveTo(float x, float y)
{
 ...
 */
void VimusMachineMangue::checkLimits()
{
 ...
 * Draw VimusMachineMangue.
 */
void VimusMachineMangue::draw(int rendermode)
{
}
 ...
 */
unsigned char** VimusMachineMangue::getCurrentFramePointer()
{
 ...
 * another objects pin.
 */
bool VimusMachineMangue::connectOutput (int outPin, VimusMachineObject * dstObj, int inPin)
{
 ...
 * objects pin.
 */
bool VimusMachineMangue::connectInput (VimusMachineObject * srcObj, int outPin, int inPin)
{
	bool ret = false;
 ...
 * another objects pin.
 */
void VimusMachineMangue::disconnectOutput (int outPin, VimusMachineObject * dstObj, int inPin)
{
 ...
 * another objects pin.
 */
void VimusMachineMangue::disconnectInput (VimusMachineObject * srcObj, int outPin, int inPin)
{
 ...
 */
void VimusMachineMangue::drawInfo ( Mat frame,
                const char* infoName,
                int infoValue,
                Point pt,
 ...
 */
void VimusMachineMangue::renderBitmapString(
		float x,
		float y,
		float z,
		void *font,
...
void VimusMachineMangue::keyBoardFunc(unsigned char key, int x, int y)
{
}

void VimusMachineMangue::specialKeyBoardFunc(int key, int x, int y)
{
}
