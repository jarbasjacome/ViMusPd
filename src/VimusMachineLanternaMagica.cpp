...
//    this->tempoPassadoMSegs = (this->tempoAtual.nsec - this->ultimoGrabCaptura.nsec) / 1000000.0f;
//    this->tempoPassadoMSegs += (this->tempoAtual.sec - this->ultimoGrabCaptura.sec)*1000;
