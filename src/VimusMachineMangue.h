...
#ifndef _VIMUSMACHINEMANGUE_H_
#define _VIMUSMACHINEMANGUE_H_
...
/**
 * VimusMachineMangue implements Mangue interactive instalation.
 *
 ...
 * @date    22.03.2012
 */
class VimusMachineMangue : public VimusMachineOpenGLObject
{
    public:
